const body = {
  body: (firstName, token) => {
    ...
    <div style="border-radius: 10px; background: #6379F4; padding: 30px">
      ...
      <a href="${process.env.EMAIL_URL}/auth/createpin/${token}" target="_blank" style="text-decoration: none; display: block; background: #ffffff; border-radius: 10px; padding: 20px">
