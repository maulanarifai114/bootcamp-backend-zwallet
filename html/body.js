const body = {
  body: (firstName, token, id) => {
    ...
    <div style="border-radius: 10px; background: #6379F4; padding: 30px">
      ...
      <p style="text-align: center; font-size: 18px; color: #ffffff; line-height: 1.2em; font-family: Helvetica, sans-serif; margin: 0 0 36px 0">Activate your account with click button below before 24 hours, or we will blacklist your email</p>
